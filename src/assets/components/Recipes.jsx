    ...
    return (
        <div className="mt-8 lg:mt-24 px-4 lg:px-0 mb-8">
            <div className="lexend space-y-4 lg:space-y-6">
                ...
                <p className="text-center lg:px-56 text-[#150b2b99] leading-7 text-base">Delve into a Treasury of Expertly Crafted Recipes, Designed to Ignite Your Culinary Passion and Elevate Your Cooking Mastery to New Heights!</p>
