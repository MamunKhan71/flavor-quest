            ...
            <div className="card bg-base-100 border border-[#28282833]">
                ...
                <div className="card-body items-center text-left w-full px-4 pt-4">
                    ...
                    <div className="w-full space-y-4">
                        <p className="text-lg text-[#282828] lexend font-medium">Ingredients: <span>{recipe.ingredients.length}</span></p>
                        <ul className="list-disc list-inside text-[#878787] fira text-lg">
                            {
                                recipe.ingredients.map(ingredient => <li key={ingredient.recipe_id}>{ingredient}</li>)
                            }
                        </ul>
                        <hr className="w-full" />
                        <div className="flex gap-4 items-center justify-center lg:justify-start">
                            <div className="flex gap-2 items-center">
                                ...
                                <span className="text-[#282828cc] text-base fira">{recipe.preparing_time} minutes</span>
                            </div>
                            <div className="flex gap-2 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span className="text-[#282828cc] text-base fira">{recipe.calories} calories</span>
                            </div>
                        </div>
                    </div>
